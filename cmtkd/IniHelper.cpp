...
char* CIniHelper::ReadString(const char *szSec, const char *szName, const char *szDefault)
{
...
int CIniHelper::ReadInt(const char *szSec, const char *szName, int nDefault)
{
	if(!szSec || !szName)
	{
